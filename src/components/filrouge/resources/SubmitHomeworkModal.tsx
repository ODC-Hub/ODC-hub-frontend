                ...
                <form onSubmit={handleSubmit} className="p-6 pt-2 space-y-5">
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:bg-gray-50 transition-colors cursor-pointer relative bg-white">
                            ...
                            <div className="flex flex-col items-center gap-3 pointer-events-none">
                                ...
                                <p className="text-sm text-gray-600">
                                    {file ? <span className="font-semibold text-gray-900">{file.name}</span> : 'Drag and drop your file here, or click to browse'}
                                </p>

                                {!file && (
                                    <span className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm">
                                        Choose File
                                    </span>
                                )}
                            </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <textarea
                                className="w-full px-3 py-3 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none min-h-[100px] resize-none"
                                value={comment}
