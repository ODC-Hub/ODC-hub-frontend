...
export default function UserDropdown() {
  ...
  const avatarUrl = user?.avatarFileId
    ? `${api.defaults.baseURL}/users/avatar/${user.avatarFileId}`
  ...
  return (
    <div className="relative">
      ...
      >
          <div className="mr-3 relative h-12 w-12">
            <img
              src={avatarUrl}
              alt="User"
      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <li>
            <DropdownItem tag="a" to="/account-settings" onItemClick={closeDropdown} className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
              <svg
                className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
                width="24"
                height="24"
